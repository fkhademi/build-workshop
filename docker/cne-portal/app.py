        ...
        if pod_id <= max_num_pods:
            ...
            <div class="col-sm-4">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">u: admin</p>
                    <a target="_blank" rel="noopener noreferrer" href="https://copilot-pod%s.%s" class="btn btn-primary">Open Co-Pilot</a>
                </div>
                </div>
            </div>
            </div>
...
run(host='0.0.0.0', reloader=True, port=5000, debug=True)
